...
public class InitiateInventory extends javax.swing.JFrame {

    private final DefaultTableModel model;
    private final DbCon con = new DbCon();

    public InitiateInventory() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Stock Initiation");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        try {
            ...
            Logger.getLogger(InitiateInventory.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new InitiateInventory().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(InitiateInventory.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private void loadToTable() throws SQLException{
        ...
        String sql = "SELECT `product`.`product_name`,`stock` FROM `product`;";
    ...
    private void saveToDatabase() throws SQLException{
        ...
        for (int i = 0; i < tblInventory.getRowCount(); i++) {
            ...
            sql = "UPDATE `product` SET `stock`="+strStock+" WHERE `product_name`='"+product+"';";
