...
public class ProformaInvoice extends javax.swing.JFrame {

    private final DefaultTableModel model;
    private final DbCon con = new DbCon();
    private final Date date = new Date();
    
    public ProformaInvoice() throws SQLException {
        initComponents();
        ...
        reset();
        resetForm();
        txt_invoice.setText(String.valueOf(nextInvoiceNo()));
    ...
    private void initComponents() {
        ...
        ddl_customer = new javax.swing.JComboBox<>();
        ...
        ddl_customerRoute = new javax.swing.JComboBox<>();
        ...
        ddl_customer.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ddl_customer.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ddl_customerActionPerformed(evt);
            }
        });
        ddl_customer.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                ddl_customerPropertyChange(evt);
            }
        });
        ...
        ddl_customerRoute.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ddl_customerRoute.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));
        ddl_customerRoute.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ddl_customerRouteActionPerformed(evt);
            }
        });
        ddl_customerRoute.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                ddl_customerRoutePropertyChange(evt);
            }
        });
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(ddl_customer, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(ddl_customerRoute, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(ddl_customerRoute, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel11))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(ddl_customer, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel17)))
    ...
    private void ddl_customerPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_ddl_customerPropertyChange

    }//GEN-LAST:event_ddl_customerPropertyChange

    private void ddl_customerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ddl_customerActionPerformed
        try {
            if(ddl_customer.getItemCount()>0){
                String customer = ddl_customer.getSelectedItem().toString();
                if(customer!=null && !"".equals(customer) && !" ".equals(customer)){
                    loadCustomerData();
                }
            }
    ...
    }//GEN-LAST:event_ddl_customerActionPerformed

    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_saveActionPerformed
        try {
            if(ddl_customer.getSelectedItem()==""){
                JOptionPane.showMessageDialog(this, "Please Select the customer.",
                                   "Error", JOptionPane.ERROR_MESSAGE);
            }
            else if(!"".equals(txt_discountRate.getText()) && ddl_discountCategory.getSelectedItem()==""){
    ...
    private void ddl_customerRouteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ddl_customerRouteActionPerformed
        try {
            String route = ddl_customerRoute.getSelectedItem().toString();
            System.out.println(route);
            if(route!= null && !" ".equals(route)){
                loadDdlCustomer(route);
            }
            
        } catch (SQLException ex) {
            Logger.getLogger(ProformaInvoice.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_ddl_customerRouteActionPerformed

    private void ddl_customerRoutePropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_ddl_customerRoutePropertyChange

    }//GEN-LAST:event_ddl_customerRoutePropertyChange
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ProformaInvoice().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(ProformaInvoice.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void loadComboItems() throws SQLException{
        ...
        //Customer
        loadDdlCustomer(null);
        
        //Route
        sql = "SELECT * FROM `customer_route`;";
        rs =  con.query(sql);
        while(rs.next()){
            ddl_customerRoute.addItem(rs.getString("route"));
        }
    ...
    private void loadDdlCustomer(String route) throws SQLException{
        String sql;
        ddl_customer.removeAllItems();
        if(route!=null && !"".equals(route)){
            sql = "SELECT * FROM `customer` WHERE `customer_route`='"+route+"';";
        }
        else{
            sql = "SELECT * FROM `customer`;";
        }
        ddl_customer.addItem("");
        ResultSet rs = con.query(sql);
        while(rs.next()){
    ...
    private void saveToDatabase(){
        ...
        String customer=(String) ddl_customer.getSelectedItem();
        String address = txt_address.getText();
        String vat_no = txt_vat_no.getText();
        
        String sql;
        int affected;
        
        sql = "insert into `proforma_invoice`(`invoice_number`,`customer_name`,`invoice_date`,`invoice_address`,`customer_vat_no`) values('"+invoiceNo+"','"+customer+"','"+strDate+"','"+address+"','"+vat_no+"');";
        affected=con.update(sql);
        if(affected>0){
            sql = "insert into `proforma_invoiceitems`(`invoice_id`,`product_name`,`qty`,`rate`,`price`,`free_i`) values ";
            String product;
            String qty;
            String rate;
            String price;
            ...
            for (int i = 0; i < tbl_items.getRowCount(); i++) {
                ...
                sql += "('"+invoiceNo+"','"+product+"','"+qty+"','"+rate+"','"+price+"','"+freei+"')";
            ...
            if(affected>0){
                ...
                sql="UPDATE `proforma_invoice` SET `total_amount`='"+totalAmount+"', `discounted_amount`='"+discountedAmount+"', `discount_amount`='"+discount+"' WHERE `invoice_number`='"+invoiceNo+"';";
                System.out.println(sql);
                affected=con.update(sql);
            }
            
            if(affected>0){
                JOptionPane.showMessageDialog(this, "Proforma Invoice Created.",
                                   "Success!", JOptionPane.INFORMATION_MESSAGE);   
            }
        }
        else{
            JOptionPane.showMessageDialog(this, "Proforma invoice not inserted. Please check your inputs again.",
                                   "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void resetForm() throws SQLException{
        model.setRowCount(0);
        reset();
        ddl_customer.setSelectedIndex(0);
        try {
            txt_invoice.setText(String.valueOf(Integer.parseInt(txt_invoice.getText())+1));
        } catch (Exception e) {
            txt_invoice.setText("");
        }
        txt_address.setText("");
    ...
    private javax.swing.JComboBox<String> ddl_customer;
    private javax.swing.JComboBox<String> ddl_customerRoute;
